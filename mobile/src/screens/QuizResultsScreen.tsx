...
const styles = StyleSheet.create({
  ...
  reviewCorrect: { borderColor: COLORS.emerald[100] },
  reviewWrong: { borderColor: COLORS.rose[400] },
  ...
  modalOptCorrect: { backgroundColor: COLORS.emerald[50], borderColor: COLORS.emerald[400] },
  modalOptWrong: { backgroundColor: COLORS.rose[50], borderColor: COLORS.rose[400] },
  modalOptLetter: {
    width: 28,
    height: 28,
    borderRadius: 14,
