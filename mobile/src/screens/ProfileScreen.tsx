...
const styles = StyleSheet.create({
  ...
  profileInfo: { flex: 1 },
  profileName: { fontSize: 18, fontWeight: '700', color: COLORS.slate[900] },
  profileEmail: { fontSize: 14, color: COLORS.slate[500], marginTop: 1 },
  serialBadge: {
  ...
  serialText: { fontSize: 12, fontWeight: '500', color: COLORS.slate[600] },
  logoutBtn: {
    width: 40,
    height: 40,
    borderRadius: 8,
  ...
  recordBody: { flex: 1 },
  recordTitle: { fontSize: 14, fontWeight: '500', color: COLORS.slate[900] },
  recordMeta: { flexDirection: 'row', gap: 12, marginTop: 2 },
  recordMetaItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  recordMetaText: { fontSize: 12, color: COLORS.slate[400] },
  recordRight: { alignItems: 'flex-end' },
  hoursText: { fontSize: 14, fontWeight: '600', color: COLORS.emerald[600] },
  presentLabel: { fontSize: 12, color: COLORS.emerald[500], marginTop: 1 },
