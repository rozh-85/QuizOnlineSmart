...
const LectureDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      ...
      {/* Mobile Nav */}
      <div className="sm:hidden fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] bg-white/80 backdrop-blur-xl border border-slate-200 rounded-2xl p-1.5 flex shadow-2xl z-50">
        <button
          onClick={() => setActiveTab('content')}
