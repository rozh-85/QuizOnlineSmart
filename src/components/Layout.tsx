          ...
          <div className="flex items-center justify-between h-16 sm:h-24">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/" className="hidden sm:flex items-center gap-4 group">
                ...
                <div>
                  <span className="text-2xl font-black bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent tracking-tighter">{t('common.eduPulse')}</span>
                  <div className="text-[11px] font-bold text-primary-600 uppercase tracking-[0.2em] -mt-1">{t('layout.chemistry')}</div>
                </div>
              </Link>
            </div>
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="font-black text-slate-900 tracking-tight">{t('common.eduPulse')}</span>
            </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-6">
            <div className="space-y-1">
              <p className="px-3 text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">{t('layout.main')}</p>
              <Link 
                to="/" 
                onClick={toggleSidebar}
            ...
            <div className="space-y-1">
              <p className="px-3 text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">{t('layout.availableLectures')}</p>
              {lectures.length > 0 ? (
          ...
          <div className="max-w-full mx-auto px-4 sm:px-8 lg:px-12">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold text-slate-700">{t('layout.eduPulseChemistry')}</span>
              </div>
